...
variable "enable_auth" {
  type        = bool
  description = "Enable Microsoft Entra authentication for the Acmebot Function App."
  default     = true
}
...
variable "user_assigned_identity_id" {
  type        = string
  default     = null
  description = "Optional user-assigned identity ID to attach to the Function App for runtime access to Key Vault/DNS."
}

variable "virtual_network_subnet_id" {
  type        = string
  default     = null
  description = "Optional existing subnet ID for Function App VNet integration."
}

variable "user_assigned_identity_client_id" {
  type        = string
  default     = null
  description = "Client ID of the user-assigned managed identity used by Acmebot."
}
